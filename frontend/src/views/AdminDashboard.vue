            ...
            <table class="w-full">
              <thead class="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase">Resident</th>
              ...
              <tbody class="divide-y divide-gray-200">
                <tr v-for="complaint in filteredComplaints" :key="complaint.id" class="hover:bg-gray-50 transition">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ complaint.residentName }}</td>
          ...
          <template v-if="reportData">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-slate-100 p-6">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <button class="px-6 py-3 bg-[#1E3A8A] text-white rounded-lg hover:bg-[#1e3a8ae6] transition">Export PDF</button>
                <button class="px-6 py-3 bg-[#15803D] text-white rounded-lg hover:bg-[#15803de6] transition">Export Excel</button>
                <button class="px-6 py-3 bg-gray-700 text-white rounded-lg hover:bg-gray-800 transition">Export CSV</button>
              </div>
            </div>
          </template>
        </div>
